...
export default defineConfig({
  ...
  rules: [
    ...
    [
      ...
      {
        background:
          'radial-gradient(50% 50% at 50% 50%, #076A12, transparent)'
      }
    ],
    [
      'bg-to2',
      {
        background: 'linear-gradient(180deg, #C25A5A 0%, #E23535 100%)'
      }
    ],
    [
      'bg-to3',
  ...
  shortcuts: {
    ...
    shadow5: 'shadow-[0px_0px_10px_1px_rgba(79,115,163,0.16)]',
